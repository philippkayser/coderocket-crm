...
import { AuthContext, User, getAutheliaAuthUrl } from '@/lib/auth';
...
export function AuthProvider({ children }: AuthProviderProps) {
  ...
  const logout = () => {
    try {
      ...
      // Zu Authelia-Logout weiterleiten
      const logoutUrl = `${AUTHELIA_URL}/api/oidc/logout?id_token_hint=${user?.idToken}&post_logout_redirect_uri=https://dev-crm.lsz.company`;
